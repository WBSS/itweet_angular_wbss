...
module.exports = function (grunt) {
  ...
  grunt.registerTask('run-on-local-server_dev_ch.wbss.dev', ['template:dev_ch.wbss.itweet.dev', '_compile', 'express', 'watch']);
  ...
  //---------------------------------------------//
  // android
  grunt.registerTask('run-android_prod', ['template:prod_ch.wbss.itweet','_clean_platform_android','_compile-and-run_android']);
